...
Unknown keys are rejected before config files are edited.
  ...
  spice: KEY argument: unknown config key: nope Hint: supported keys: model,
         ...
         run.subagent_wake, run.subagent_max_exchanges, permission.unattended,
         sandbox.mode, sandbox.require, sandbox.read, sandbox.readable_roots,
         sandbox.writable_roots, sandbox.network, shell, compaction.auto,
         notices.fswatch, notices.cr_comments, notices.dune_diagnostics,
         notices.dune_build, workspace.tooling, instructions.global,
         instructions.project, instructions.claude_md,
