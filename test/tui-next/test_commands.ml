...
(* The slash palette and command dispatch (doc/ui-design/03-composer.md §Slash
   ...
   guard); the [--sandbox] flag override needs a harness [sandbox] seam not yet
   present and is deferred. *)
...
22 |
23 |
24 |   ! not logged in · /login · …t-cmd-palette-filter · gpt-5.5 medium · dune: ✗|}]
...
22 |
23 |
24 |   ! not logged in · /login · …-cmd-palette-nomatch · gpt-5.5 medium · dune: ✗|}]
...
22 |
23 |
24 |   ! not logged in · /login · …next-cmd-palette-esc · gpt-5.5 medium · dune: ✗|}]
...
22 |
23 |
24 |   ! not logged in · /login · …i-next-cmd-mode-plan · gpt-5.5 medium · dune: ✗|}]
...
22 |
23 |
24 |   ! not logged in · /login · …-next-cmd-mode-build · gpt-5.5 medium · dune: ✗|}]
...
22 | ❯ message spice
23 | ────────────────────────────────────────────────────────────────────────────────
24 |   ! not logged in · /login · …e-tui-next-cmd-shell · gpt-5.5 medium · dune: ✗|}]

[%%run_tests "spice.tui-next.commands"]
