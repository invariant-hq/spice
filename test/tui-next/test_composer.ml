...
22 |   line two
23 | ────────────────────────────────────────────────────────────────────────────────
24 |   …ice-tui-next-composer-multiline · gpt-5.5 medium · dune: ✗  ? for shortcuts|}];
...
23 | ────────────────────────────────────────────────────────────────────────────────
24 |   …/spice-tui-next-composer-paste · gpt-5.5 medium · dune: ✗   ? for shortcuts|}];
...
22 | ❯ message spice
23 | ────────────────────────────────────────────────────────────────────────────────
24 |   …/spice-tui-next-composer-ctrlc · gpt-5.5 medium · dune: ✗   ? for shortcuts|}];
  Tui.keys t Keys.up;
  Tui.settle t;
  Tui.print t;
  [%expect {|01 |
...
24 |   …e-tui-next-composer-affordances · gpt-5.5 medium · dune: ✗  ? for shortcuts|}];
  Tui.keys t Keys.escape;
  Tui.settle t;
  Tui.print t;
  [%expect {|01 |
