...
(** The permission dialog form (03-ia-screens-overlays.md §Dialogs,
    07-dialogs.md §Permission).
...
(** [key ev t] folds one key: [1]/[y] allow once, [2]/[a] allow for the session,
    [3]/[d]/[n]/[esc] deny with feedback, arrows move the cursor, [enter]
    confirms it, and [ctrl+o] expands the diff. *)
